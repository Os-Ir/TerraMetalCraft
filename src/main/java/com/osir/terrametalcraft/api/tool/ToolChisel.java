...
public class ToolChisel extends ToolBase implements IGrindstoneTool {
	...
	public boolean matches(ItemStack[] parts) {
		...
		return MaterialUtil.getMaterialTag(ModSolidShapes.CHISEL_HEAD).contains(parts[0].getItem()) && (item2 == Items.STRING || item2 == ModItems.THIN_STRAW_ROPE) && (item3 == Items.STICK) && parts[3].isEmpty() && parts[4].isEmpty();
	}
