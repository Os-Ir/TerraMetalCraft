...
import com.osir.terrametalcraft.api.capability.StoragePottery;
...
//			GrassDropSerializer::new);
	...
	public static void registerTool() {
		...
		ModRegistries.REGISTRY_TOOL.register(ToolJavelin.REGISTRY_NAME, ToolJavelin.INSTANCE);
	}
	...
	public static void registerCapability() {
		...
		CapabilityManager.INSTANCE.register(IPottery.class, new StoragePottery(), CapabilityPottery::new);
		...
		CapabilityListener.register(CapabilityPottery.KEY, ModCapabilities.POTTERY);
	}
}